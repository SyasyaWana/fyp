...
class EvaluationForm1_SV extends StatefulWidget {
  final String studentName;

  const EvaluationForm1_SV({Key? key, required this.studentName}) : super(key: key);

  @override
  _EvaluationForm1_SVState createState() => _EvaluationForm1_SVState();
}

class _EvaluationForm1_SVState extends State<EvaluationForm1_SV> {
      ...
      if (form['Form Type'] == 'Project Progress Form') {
        ...
        for (var subCriterionIndex = 0; subCriterionIndex < subCriteriaList.length; subCriterionIndex++) {
          ...
          if (selectedScore[key] != null) {
            // Convert the score to a double and apply the formula
