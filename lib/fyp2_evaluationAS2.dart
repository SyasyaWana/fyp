...
class AS2_2 extends StatefulWidget {
  ...
  @override
  State<AS2_2> createState() => _AS2_2State();
}

class _AS2_2State extends State<AS2_2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: const Text("Evaluate Student"),
                        ...
                        ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => assesor2_fyp2(studentName: studentName),
                              ),
                            );
                          },
