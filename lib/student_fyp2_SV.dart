...
class STUDENTFYP2SV extends StatefulWidget {
  ...
  @override
  State<STUDENTFYP2SV> createState() => _STUDENTFYP2SVState();
}

class _STUDENTFYP2SVState extends State<STUDENTFYP2SV> {
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const FYP2RESULTSV(), // Navigate to the result screen
                    ),
                  );
                },
                        ...
                        ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => EvaluationForm2_SV(studentName: studentName),
                              ),
                            );
                          },
