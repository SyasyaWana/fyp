...
import 'package:systemfyp/evaluationform1_AS.dart';
import 'package:systemfyp/fyp1_evaluation_AS2.dart';
import 'package:systemfyp/viewstudentSV.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class STUDENTFYP1EVALUATION extends StatefulWidget {
  const STUDENTFYP1EVALUATION({super.key});

  @override
  State<STUDENTFYP1EVALUATION> createState() => _STUDENTFYP1EVALUATIONState();
}

class _STUDENTFYP1EVALUATIONState extends State<STUDENTFYP1EVALUATION> {
          ...
          Expanded(
            child: FirebaseAnimatedList(
              ...
              itemBuilder: (BuildContext context, DataSnapshot snapshot, Animation<double> animation, int index) {
                // Extract Assessor 1 Name from the snapshot
                String assessor1Name = snapshot.child('Assessor 1 Name')
                    .value
                    .toString();

                // Check if the Assessor 1 Name matches the logged-in user's full name (case-insensitive and trimmed)
                if (assessor1Name.trim().toLowerCase() ==
                  ...
                  String supervisorName = snapshot
                      ...
                      .value
                      .toString();
                  String assessor2Name = snapshot
                      .child('Assessor 2 Name')
                      .value
                      .toString();
