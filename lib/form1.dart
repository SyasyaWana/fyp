...
class _Form1State extends State<Form1> {
  ...
  void _deleteData(String key) {
    setState(() {
      fyp1forms.removeWhere((fyp1form) => fyp1form['key'] == key);
    });
  ...
  Widget _buildEditForm(Map<String, String> fyp1form) {
    return Padding(
          ...
          ElevatedButton(
            onPressed: () {
              if (_validateForm()) {
                ...
                String key = fyp1form['key'] ?? '';

                setState(() {
                  fyp1form['Criterion Name'] = updatedCriterionName;
                  fyp1form['Sub-Criteria'] = updatedSubcriteria;
                  fyp1form['Criterion Weightage'] = updatedCriterionWeightages;
                  fyp1form['Sub-Criterion Weightages'] =
                      updatedSubCriterionWeightages;
                });
                      ...
                      children: [
                        const Row(
                          ...
                          children: [
                            SizedBox(height: 33),
                            Text(
                              "IPB 49804 - FINAL YEAR PROJECT 1",
                              style: TextStyle(
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      setState(() {
                        fyp1forms.remove(fyp1form); // Deselect the student
