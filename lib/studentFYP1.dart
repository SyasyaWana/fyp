...
class FYP1STUDENT extends StatefulWidget {
  const FYP1STUDENT({super.key});

  @override
  State<FYP1STUDENT> createState() => _FYP1STUDENTState();
}

class _FYP1STUDENTState extends State<FYP1STUDENT> {

  final DatabaseReference _databaseReference = FirebaseDatabase.instance.reference().child('students FYP 1');
