...
import 'package:path_provider/path_provider.dart'; // Import path_provider for directory handling
import 'dart:io'; // Import dart:io for File class
import 'dart:typed_data';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/services.dart' show rootBundle;

class Result2SV extends StatefulWidget {
  final String studentName;
  final String id;
  final String projectTitle;
  final String supervisorName;

  const Result2SV({Key? key,
  ...
  @override
  State<Result2SV> createState() => _Result2SVState();
}
class _Result2SVState extends State<Result2SV> {
  ...
  double totalScore = 0; // Initialize total score to 0

  @override
  void initState() {
    super.initState();
    _retrieveFormScore();
    // Calculate the total marks by summing up the scores
    totalScore = averagePresentationScore + totalProgressProjectFormScore + averageFinalReportScore + totalTechnicalPaperFormScore;
  }
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Center(
                child: pw.Text(
                  "FINAL YEAR PROJECT 2 (IPB 49906)",
                  style: pw.TextStyle(
                    fontSize: 15,
                    fontWeight: pw.FontWeight.bold,
                  ),
