...
class ViewResult1 extends StatefulWidget {
  ...
  @override
  State<ViewResult1> createState() => _ViewResult1State();
}

class _ViewResult1State extends State<ViewResult1> {
  ...
  void initState() {
    ...
    totalScore = totalPresentationFormScore + totalPresentationForm2Score +
        totalProgressProjectFormScore + totalFinalReportFormScore + totalFinalReportFormSVScore;
  }
