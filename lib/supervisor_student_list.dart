...
class StudentListSV extends StatefulWidget {
  ...
  @override
  State<StudentListSV> createState() => _StudentListSVState();
}

class _StudentListSVState extends State<StudentListSV> {
  ...
  // Keys for FirebaseAnimatedList instances
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 20),
                  Expanded(
                    child: (selectedFYP == "FYP 1")
                        ? FirebaseAnimatedList(
                      key: _fyp1ListKey,
                      query: _databaseReferenceFYP1.orderByChild('Supervisor Name').equalTo(widget.supervisorName),
                      itemBuilder: (BuildContext context, DataSnapshot snapshot, Animation<double> animation, int index) {
                        ...
                        ? FirebaseAnimatedList(
                      key: _fyp2ListKey,
                      query: _databaseReferenceFYP2.orderByChild('Supervisor Name').equalTo(widget.supervisorName),
                      itemBuilder: (BuildContext context, DataSnapshot snapshot, Animation<double> animation, int index) {
                        String studentName = snapshot.child('Student Name').value.toString();
                        String id = snapshot.child('ID').value.toString();
                        String projectTitle = snapshot.child('Project Title').value.toString();
