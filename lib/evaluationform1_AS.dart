...
class EvaluationForm1_AS extends StatefulWidget {
  final String studentName;

  const EvaluationForm1_AS({Key? key, required this.studentName}) : super(key: key);

  @override
  _EvaluationForm1_ASState createState() => _EvaluationForm1_ASState();
}

class _EvaluationForm1_ASState extends State<EvaluationForm1_AS> {
  final DatabaseReference _databaseReference = FirebaseDatabase.instance.reference().child('FYP 1 Form');
    ...
    scoresCollection
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        setState(() {
          ...
          totalPresentationFormScore = data['totalPresentationFormScore'];
          totalFinalReportFormScore = data['totalFinalReportFormScore'];
        });
      }
    });
  }
  ...
  void _calculateTotalScore() {
    ...
    setState(() {
      totalPresentationFormScore = presentationFormSum;
      totalFinalReportFormScore = finalReportFormSum;
    });
  }
                        ...
                        DropdownButton<String>(
                          ...
                          onChanged: (newValue) {
                            setState(() {
                              ...
                              showPresentationForm = (newValue == 'Presentation Form');
                              showFinalReportForm = (newValue == 'Final Report Form');
                            });
                          },
                        ),
                        const SizedBox(height: 25),
                        if (showPresentationForm || showFinalReportForm)
                          Column(
  ...
  Widget _buildDisplay() {
    ...
    if (selectedFormType == 'Presentation Form' && totalPresentationFormScore != null) {
      widgets.add(
        Padding(
    ...
    } else if (selectedFormType == 'Final Report Form' && totalFinalReportFormScore != null) {
      widgets.add(
        Padding(
          padding: const EdgeInsets.symmetric(vertical: 16.0),
          child: Text(
